...
const SCENARIOS: Scenario[] = [
  {
    ...
    lines: [
      { kind: "cmd",     text: "sandbox deploy --template approval-workflow" },
      { kind: "info",    text: "Scanning sub-epf-sandbox-internal ..." },
      { kind: "info",    text: "Template   : Automated Approval Workflow" },
  ...
  },
  {
    ...
    lines: [
      { kind: "cmd",     text: "sandbox deploy --template scheduled-automation" },
      { kind: "info",    text: "Scanning sub-epf-sandbox-internal ..." },
      { kind: "info",    text: "Template   : Scheduled Task Runner" },
      { kind: "info",    text: "Resources  : Logic App + LAW + Key Vault" },
      ...
      { kind: "divider", text: "" },
      { kind: "success", text: "Submitted → rg-scheduler-b7e1d4-rg" },
      { kind: "info",    text: "ARM status : Accepted · Running" },
    ],
  },
  {
