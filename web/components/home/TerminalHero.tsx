...
const SCENARIOS: Scenario[] = [
  {
    ...
    slug: "logic-app",
    lines: [
      { kind: "cmd",     text: "sandbox deploy --template logic-app" },
      { kind: "info",    text: "Scanning sub-epf-sandbox-internal ..." },
      { kind: "info",    text: "Template   : Blank Workflow" },
      { kind: "info",    text: "Resources  : Logic App + LAW + Key Vault" },
      ...
      { kind: "divider", text: "" },
      { kind: "success", text: "Submitted → rg-workflow-a3f8c2-rg" },
      { kind: "info",    text: "ARM status : Accepted · Running" },
    ],
  },
  {
    id: "logic-app-storage",
    label: "logic-app-storage",
    slug: "logic-app-storage",
    lines: [
      { kind: "cmd",     text: "sandbox deploy --template logic-app-storage" },
      { kind: "info",    text: "Scanning sub-epf-sandbox-internal ..." },
      { kind: "info",    text: "Template   : Workflow + File Storage" },
      { kind: "info",    text: "Resources  : Logic App + Storage Account + LAW + Key Vault" },
      { kind: "info",    text: "Region     : malaysiawest" },
      { kind: "divider", text: "" },
      ...
      { kind: "divider", text: "" },
      { kind: "success", text: "Submitted → rg-workflowstorage-b7e1d4-rg" },
      { kind: "info",    text: "ARM status : Accepted · Running" },
    ],
  },
];
