...
export default function BuilderPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-12">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-text">Build Your Own Setup</h1>
        <p className="mt-2 text-text-muted">
          Choose resources one at a time and configure each one. Review your
          complete setup before submitting.
        </p>
      </div>
