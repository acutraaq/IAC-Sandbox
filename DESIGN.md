...
> This is the single source of truth for visual design tokens. `.claude/rules/design-system.md` (auto-loads when editing any `web/` file) just points here — don't maintain two copies.
